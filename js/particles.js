...
const elButton = document.querySelector(".container__btn");
...
const treatmojis = ["Асу Асу", "Щекотно", "Хватит", "Аы", "Ээээ", "Эээ Джиган топ", "А да?", "Ну да", "А?", "Барни", "Бабабуй", "кста", "реальна", "наарот", "акак", "ачевсмысле"];
const treats = [];
const radius = 15;
...
function createTreat() /* create a treat */ {
  ...
  const treat = {
    ...
    position: { x: rect.left, y: rect.top + 350 },
    velocity: { x: vx, y: vy },
    mass: 0.1, //kg
